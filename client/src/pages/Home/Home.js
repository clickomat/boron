            ...
            <div className="col s12">
              <div className="card-panel mission">
                ...
                <p className="statement">
                  Our goal with Accessible Travel is to create safe, sensory
                  friendly certified travel options for parents and individuals
                  on the spectrum.
                </p>
                <p className="statement">
                  Taking a vacation together, as a family, can be one of the
                  bigger challenges with having a family member who has sensory
                  processing complications. Our site provides parents with a
